  ...
  document.body.insertAdjacentHTML("afterbegin", `
    ...
    <nav class="nav"><div class="nav-in">
      ...
      <div class="nav-links">
        ...
        <a href="alpha.html" class="${here("alpha.html") ? "on" : ""}">Alpha of the Day</a>
      </div>
    ...
    <nav class="tabbar" aria-label="Sections">
        ...
        <a href="alpha.html" class="${here("alpha.html") ? "on" : ""}"><svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M13 3 5 13.5h6L11 21l8-10.5h-6z"/></svg><span>Alpha</span></a>
    </nav>
  `);
    ...
    document.body.insertAdjacentHTML("beforeend", `
      <footer class="site-foot">
        ...
        <span class="site-foot-links">
          ...
          <a href="alpha.html">Alpha of the Day</a>
        </span>
      </footer>`);
